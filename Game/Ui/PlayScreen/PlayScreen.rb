...
class PlayScreen
	...
	def initialize(grid, accueil)
		...
		@controlPanel.attach(Gtk::Label.new("\n\n\n\n\n\n"), 0, 10, 2, 6)
		# FIRST ROW / FIRST COL
		@controlPanel.attach(newH.gtkObject,    1, 2, 6, 7)
		@controlPanel.attach(cancelH.gtkObject, 3, 4, 6, 7)

		@controlPanel.attach(Gtk::Label.new("\n"), 0, 10, 7, 8)

		# SECOND ROW / FIRST COL
		@controlPanel.attach(ud.gtkObject, 1, 2, 8, 9)
		@controlPanel.attach(rd.gtkObject, 2, 3, 8, 9)
		@controlPanel.attach(cl.gtkObject, 3, 4, 8, 9)

		@controlPanel.attach(Gtk::Label.new("\t\t"), 3, 4, 0, 11)

		# FIRST ROW / SECOND COL
		@controlPanel.attach(h1.gtkObject, 4, 6, 6, 7)
		@controlPanel.attach(h2.gtkObject, 7, 8, 6, 7)
